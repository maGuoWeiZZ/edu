...
<div class="modal fade menu-setpassword" tabindex="-1" role="dialog">
    <form name="formPwd" action="${path}teacher/modifyPwd?tNo=${sessionScope.user.tNo}"
...
<%--学生成绩查询模态框--%>
<div class="modal fade menu-studentScore" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <form action="${path}teacher/selectScoreBySno"
                  method="post">
                <div class="modal-body">
                    <table class="table">
                        <tbody>
...
<%--课程成绩查询模态框--%>
<div class="modal fade menu-courseScore" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <form action="${path}teacher/selectScoreByCno"
                  method="post">
                <div class="modal-body">
                    <table class="table">
                        <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="number" class="form-control" placeholder="请输入课程号"
                                       name="cNo">
                            </td>
                        </tr>
                        </tbody>
...
<%--按学生录入成绩模态框--%>
<div class="modal fade menu-inputScoreBySno" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <form action="${path}teacher/selectScoreBySno?type=input"
                  method="post">
                <div class="modal-body">
                    <table class="table">
                        <tbody>
...
<%--按课程录入成绩模态框--%>
<div class="modal fade menu-inputScoreByCno" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <form action="${path}teacher/selectScoreByCno?type=input"
                  method="post">
                <div class="modal-body">
                    <table class="table">
                        <tbody>
...
<%--学生成绩排名查询模态框--%>
<div class="modal fade menu-rank" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <form action="${path}teacher/selectSCOrderByscore"
                  method="post">
                <div class="modal-body">
                    <table class="table">
                        <tbody>
