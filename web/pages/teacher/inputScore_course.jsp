            ...
            <section class="col-lg-12 widget-drag">
                <div class="box table">
                    <div class="box-header" data-trigger="drag">
                        ...
                        <label class="label label-success">${requestScope.inputScoreMsg}</label>
                                ...
                                <c:forEach items="${requestScope.scList}" var="scList">
                                    <tr>
                                        <form onsubmit="return checkScore()"
                                              action="${path}teacher/inputScore" method="post">
                                            ...
                                            <c:if test="${scList.score == -1}">
                                                <td class="td-status">
                                                    <span class="label label-danger">未录入</span>
                                                </td>
                                                <td class="td-status">
                                                    <input class="input-sm" type="number" name="score" id="score">
                                                    <button type="submit" class="label label-primary">录入成绩</button>
                                                </td>
                                            </c:if>
