                ...
                <section class="col-md-12 col-sm-12 col-xs-12">
                    <div class="box form">
                        <div class="box-header">
                            <h3 class="box-title">修改教师信息</h3>
                        </div>
                        <div class="box-body">
                            <c:if test="${not empty requestScope.teacher}">
                                <form name="form1" action="${path}admin/updateTeacher"
                                      onsubmit="return checkTeaUpdate()" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                               value="${teacher.tNo}" disabled>
                                    </div>
                                    <input type="hidden" name="tNo" value="${teacher.tNo}">
                                    <div class="form-group">
                                        <label>姓名</label>
                                        <input type="text" class="form-control" name="tName"
                                               placeholder="请输入姓名" value="${teacher.tName}">
                                    </div>
                                    <div class="form-group">
                                        <label>性别</label>
                                        <div class="radio">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="tAge" id="tAge"
                                               placeholder="请输入年龄" value="${teacher.tAge}">
                                    </div>
                                    <div class="form-group">
                                        <label>密码</label>
                                        <input type="text" class="form-control" name="tPassword"
                                               placeholder="请输入密码" value="${teacher.tPassword}">
                                    </div>
                                    <div class="form-group">
                                        <label>薪资</label>
                                        <input type="number" class="form-control" name="tSalary"
                                               placeholder="请输入薪资" value="${teacher.tSalary}">
                                    </div>
                                    <div class="form-group">
                                        <label>专业</label>
                            ...
                            <c:if test="${empty requestScope.teacher}">
                                <label class="label label-danger">不存在该教师</label>
                            </c:if>
                        </div>
                    </div>
                </section>
            ...
            <script type="text/javascript">
                function checkTeaUpdate() {
                    ...
                    if (form1.tName.value == '' || form1.tName.value == null) {
                        ...
                        msg.innerText = "年龄范围不正确（18-65）！";
                        return false;
                    }else if (form1.tPassword.value == '' || form1.tPassword.value == null) {
