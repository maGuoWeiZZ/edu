                ...
                <section class="col-md-12 col-sm-12 col-xs-12">
                    <div class="box form">
                        <div class="box-header">
                            <h3 class="box-title">添加学生信息</h3>
                        </div>
                        <div class="box-body">
                            <form name="form1" action="${path}admin/addStu"
                                  onsubmit="return checkStu()" method="post">
            ...
            <script type="text/javascript">
                function checkStu() {
                    ...
                    if (form1.sName.value == '' || form1.sName.value == null) {
                        ...
                        return false;
                    } else if (!(form1.sAge.value > 18 && form1.sAge.value < 35)) {
                        msg.innerText = "年龄范围有误(18-35)！";
                        return false;
