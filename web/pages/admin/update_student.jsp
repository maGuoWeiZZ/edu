    ...
    <div class="page-wrapper">
        ...
        <section class="page-body">
                    ...
                    <div class="box form">
                        ...
                        <div class="box-body">
                            <c:if test="${not empty requestScope.student}">
                                <form name="form1" action="${path}admin/updateStu"
                                      onsubmit="return checkStuUpdate()" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                               value="${requestScope.student.sNo}" disabled>
                                    </div>
                                    <input type="hidden" name="sNo" value="${requestScope.student.sNo}">
                                    <div class="form-group">
                                        <label>姓名</label>
                                        <input type="text" class="form-control" name="sName"
                                               placeholder="请输入姓名" value="${requestScope.student.sName}">
                                    </div>
                                    <div class="form-group">
                                        <label>性别</label>
                                        <div class="radio">
                                    ...
                                    <div class="form-group">
                                        <label>年龄</label>
                                        <input type="number" class="form-control" name="sAge" id="sAge"
                                               placeholder="请输入年龄" value="${requestScope.student.sAge}">
                                    </div>
                                    <div class="form-group">
                                        <label>密码</label>
                                        <input type="text" class="form-control" name="sPassword"
                                               placeholder="请输入密码" value="${requestScope.student.sPassword}">
                                    </div>
                                    <div class="form-group">
                                        <label>专业</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="sClass" class="form-control">
                                            ...
                                            <option value="2019级1班">2019级1班</option>
                                            <option value="2019级2班">2019级2班</option>
                                            <option value="2019级3班">2019级3班</option>
                                            <option value="2020级1班">2020级1班</option>
                                            <option value="2020级2班">2020级2班</option>
                                            <option value="2020级3班">2020级3班</option>
                                            <option value="2021级1班">2021级1班</option>
                                            <option value="2021级2班">2021级2班</option>
                                            <option value="2021级3班">2021级3班</option>
                                        </select>
                                    </div>
                            ...
                            <c:if test="${empty requestScope.student}">
                                <label class="label label-danger">不存在该学生</label>
                            </c:if>
                        </div>
                    </div>
                </section>
            ...
            <script type="text/javascript">
                function checkStuUpdate() {
                    var reg = /^[a-zA-Z\u4e00-\u9fa5]+$/;
                    var msg = document.getElementById("msg");
                    if (form1.sName.value == '' || form1.sName.value == null) {
                        msg.innerText = "姓名不能为空！";
                        return false;
                    } else if(!(reg.test(form1.sName.value))) {
                        msg.innerText = "姓名格式不正确！";
                        return false;
                    }else if (form1.sSex.value == '' || form1.sSex.value == null) {
                        msg.innerText = "请选择性别！";
                        return false;
                    } else if (form1.sAge.value == '' || form1.sAge.value == null) {
                        msg.innerText = "年龄不能为空！";
                        return false;
                    } else if (!(form1.sAge.value >= 18 && form1.sAge.value <= 30)) {
                        msg.innerText = "年龄范围不正确（18-35）！";
                        return false;
                    } else if (form1.sPassword.value == '' || form1.sPassword.value == null) {
                        msg.innerText = "密码不能为空！";
                        return false;
                    } else if (form1.sDept.value == '' || form1.sDept.value == null) {
                        msg.innerText = "请选择专业！";
                        return false;
                    } else if (form1.sClass.value == '' || form1.sClass.value == null) {
                        msg.innerText = "请选择班级！";
                        return false;
                    } else {
                        msg.innerText = '';
