                ...
                <section class="col-md-12 col-sm-12 col-xs-12">
                    <div class="box form">
                        <div class="box-header">
                            <h3 class="box-title">添加管理员信息</h3>
                        </div>
                        <div class="box-body">
                            <form name="form1" action="${path}admin/addUser"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="username"
                                           placeholder="请输入用户名" id="username" onblur="checkName()">
                                ...
                                <div class="form-group">
                                    <label>电子邮箱</label>
                                    <input type="text" class="form-control" name="detail.email"
                                           placeholder="请输入电子邮箱" id="email">
                                </div>
                                <div class="form-group">
                                    <label>电话号码</label>
                                    <input type="text" class="form-control" name="detail.phone"
                                           placeholder="请输入电话号码" id="phone">
                                </div>
